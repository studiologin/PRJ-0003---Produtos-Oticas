              ...
              <div className="relative">
                <div className="relative flex items-center justify-center py-10 md:py-20">
                  ...
                  <motion.div 
                    ...
                    whileInView={{ opacity: 1, x: 0 }}
                    viewport={{ once: true }}
                    className="absolute top-0 md:top-8 right-0 md:right-32 z-20 bg-white/80 backdrop-blur-md p-5 rounded-[24px] shadow-2xl border border-white/50 max-w-[180px]"
                  >
                  ...
                  <motion.div 
                    ...
                    className="absolute bottom-0 md:bottom-8 left-0 md:left-32 z-20 bg-white/80 backdrop-blur-md p-5 rounded-[24px] shadow-2xl border border-white/50 max-w-[180px]"
                  >
