...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const renderSidebarContent = () => (
    <div className="flex flex-col h-full bg-[#1A3A5C] text-white">
      ...
      <div className="p-4 mt-auto border-t border-white/10 space-y-2">
        ...
        <button 
          ...
          className={`hidden lg:flex items-center px-4 py-3 w-full rounded-xl transition-all font-medium text-sm text-white/50 hover:bg-white/10 hover:text-white ${isSidebarCollapsed ? 'justify-center' : 'gap-4'}`}
  ...
  return (
    <div className="min-h-screen bg-[#F5F4F0] flex overflow-hidden">
      ...
      <motion.div 
        ...
        className="hidden lg:block bg-[#1A3A5C] h-screen shrink-0 relative rounded-tr-3xl rounded-br-3xl overflow-hidden shadow-sm z-30"
      >
        {renderSidebarContent()}
      </motion.div>
